...
public class TrainObject {
	...
	public synchronized int getMaxRunningNotch() {
	...
	public synchronized int getTrainNumber() {
		return trainNumber;
	}

	public synchronized void setTrainNumber(int trainNumber) {
		this.trainNumber = trainNumber;
	}

	public synchronized byte getRmxChannel() {
		return rmxChannel;
	}

	public synchronized void setRmxChannel(byte rmxChannel) {
		this.rmxChannel = rmxChannel;
	}

	public synchronized String getTrainName() {
		return trainName;
	}
