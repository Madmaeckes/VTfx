...
public class Send {
	 ...
	 * Zeichen nicht erlaubt. <COUNT> = 7. Wird beim Loeschen die
 	 * Loknummer 0000 eingegeben, wird die gesamte Datenbank geloescht.</BR>
	 * 32 - 
	 * Lesen eines Datensatzes ueber Loknummer: Angabe der alphanumerische
	 ...
	 * Bit 0 = 0: Fahrtrichtung vorwaerts</BR>
	 * Bit 0 = 1: Fahrtrichtung rueckwaerts
	 * */
	 ...
	 *            Hoechstgeschwindigkeit 1 bis 7</BR>Bit 3 bis Bit 5:
